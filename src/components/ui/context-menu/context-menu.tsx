...
const ContextMenuSubTrigger = ({
  ...
  <ContextMenuPrimitive.SubTrigger
    ref={ref}
    className={clsxm(
      'focus:bg-accent text-foreground data-[state=open]:bg-accent data-[state=open]:text-foreground flex select-none items-center rounded-[5px] px-2.5 py-1.5 outline-none',
      inset && 'pl-8',
